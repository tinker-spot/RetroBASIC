...
{
    public class GreaterThanEqualToken : OperatorToken
    {
        public GreaterThanEqualToken() : base(">=", OperatorTokenType.GreaterThanEqual, OperatorPrecedenceLevel.Comparison)
        {
